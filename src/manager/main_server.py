...
services_managed = ["brb","unbrb","discord","shoutout","todolist","collect","invest","give","roomba","steal","lurk","points","suika","timer","timezone","unlurk"]
services_managed += ["move_fishing","admin_logger","chat_logger","command_logger"]
manager_service_name = "twitch_server_manager"
running_processes = {}
